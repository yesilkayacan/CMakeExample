        ...
        bool ret = true;
            switch (p->sType) {
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROPERTIES_2_KHR: {
                    ...
                    ret = ret && (s->properties.limits.maxSamplerAllocationCount >= 4000);
                    ret = ret && (s->properties.limits.maxSamplerAnisotropy >= 16);
                    ret = ret && (s->properties.limits.maxSamplerLodBias >= 4);
                    ret = ret && (s->properties.limits.maxStorageBufferRange >= 1073741824);
                    ret = ret && (s->properties.limits.maxTessellationControlPerPatchOutputComponents >= 120);
                    ret = ret && (s->properties.limits.maxTessellationControlPerVertexInputComponents >= 124);
                    ret = ret && (s->properties.limits.maxTessellationControlPerVertexOutputComponents >= 124);
                ...
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_1_PROPERTIES: {
                    VkPhysicalDeviceVulkan11Properties* s = static_cast<VkPhysicalDeviceVulkan11Properties*>(static_cast<void*>(p));
                    ret = ret && (s->maxMemoryAllocationSize >= 1610612736);
                    ret = ret && (s->maxMultiviewInstanceIndex >= 134217727);
                    ret = ret && (s->maxMultiviewViewCount >= 6);
                    ret = ret && (s->maxPerSetDescriptors >= 700);
                    ret = ret && (s->subgroupSize >= 1);
                    ret = ret && ((s->subgroupSize & (s->subgroupSize - 1)) == 0);
                    ret = ret && (vpCheckFlags(s->subgroupSupportedOperations, (VK_SUBGROUP_FEATURE_BASIC_BIT | VK_SUBGROUP_FEATURE_ARITHMETIC_BIT | VK_SUBGROUP_FEATURE_SHUFFLE_BIT | VK_SUBGROUP_FEATURE_QUAD_BIT)));
                    ret = ret && (vpCheckFlags(s->subgroupSupportedStages, (VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT | VK_SHADER_STAGE_FRAGMENT_BIT | VK_SHADER_STAGE_COMPUTE_BIT | VK_SHADER_STAGE_ALL_GRAPHICS)));
                } break;
                case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_PROPERTIES: {
                    VkPhysicalDeviceVulkan12Properties* s = static_cast<VkPhysicalDeviceVulkan12Properties*>(static_cast<void*>(p));
                    ...
                    ret = ret && (s->maxPerStageDescriptorUpdateAfterBindUniformBuffers >= 15);
                    ret = ret && (s->maxPerStageUpdateAfterBindResources >= 159);
                    ret = ret && (s->maxTimelineSemaphoreValueDifference >= 0);
                    ret = ret && (s->maxUpdateAfterBindDescriptorsInAllPools >= 1048576);
                    ret = ret && (vpCheckFlags(s->shaderSignedZeroInfNanPreserveFloat32, VK_TRUE));
                    ret = ret && (vpCheckFlags(s->supportedDepthResolveModes, (VK_RESOLVE_MODE_SAMPLE_ZERO_BIT)));
                    ret = ret && (vpCheckFlags(s->supportedStencilResolveModes, (VK_RESOLVE_MODE_SAMPLE_ZERO_BIT)));
...
static const VpProfileDesc vpProfiles[] = {
    ...
    VpProfileDesc{
        ...
        nullptr, 0,
        &VP_LUNARG_DESKTOP_BASELINE_2023::deviceExtensions[0], static_cast<uint32_t>(sizeof(VP_LUNARG_DESKTOP_BASELINE_2023::deviceExtensions) / sizeof(VP_LUNARG_DESKTOP_BASELINE_2023::deviceExtensions[0])),
        nullptr, 0,
        &VP_LUNARG_DESKTOP_BASELINE_2023::featureStructTypes[0], static_cast<uint32_t>(sizeof(VP_LUNARG_DESKTOP_BASELINE_2023::featureStructTypes) / sizeof(VP_LUNARG_DESKTOP_BASELINE_2023::featureStructTypes[0])),
        VP_LUNARG_DESKTOP_BASELINE_2023::featureDesc,
        &VP_LUNARG_DESKTOP_BASELINE_2023::propertyStructTypes[0], static_cast<uint32_t>(sizeof(VP_LUNARG_DESKTOP_BASELINE_2023::propertyStructTypes) / sizeof(VP_LUNARG_DESKTOP_BASELINE_2023::propertyStructTypes[0])),
        VP_LUNARG_DESKTOP_BASELINE_2023::propertyDesc,
        nullptr, 0,
        nullptr, 0,
        &VP_LUNARG_DESKTOP_BASELINE_2023::formatStructTypes[0], static_cast<uint32_t>(sizeof(VP_LUNARG_DESKTOP_BASELINE_2023::formatStructTypes) / sizeof(VP_LUNARG_DESKTOP_BASELINE_2023::formatStructTypes[0])),
        &VP_LUNARG_DESKTOP_BASELINE_2023::formatDesc[0], static_cast<uint32_t>(sizeof(VP_LUNARG_DESKTOP_BASELINE_2023::formatDesc) / sizeof(VP_LUNARG_DESKTOP_BASELINE_2023::formatDesc[0])),
        VP_LUNARG_DESKTOP_BASELINE_2023::chainerDesc,
    },
#endif
#ifdef VP_LUNARG_desktop_portability_2022
    VpProfileDesc{
